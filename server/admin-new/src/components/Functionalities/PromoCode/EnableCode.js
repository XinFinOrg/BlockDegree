...
class EnablePromoCode extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit() {
    ...
    if (!codeNameValid) {
      return showNotification("danger", "Enable Code", "Invalid code name");
    }
    // data is valid
    axios
      .post("/api/activatePromoCode", {
...
export default EnablePromoCode;
