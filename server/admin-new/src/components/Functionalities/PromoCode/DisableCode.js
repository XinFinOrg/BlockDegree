...
class DisablePromoCode extends Component {
  ...
  handleSubmit() {
    ...
    if (!codeNameValid) {
      return showNotification("danger", "Disable Code", "Invalid code name");
    }
    // data is valid
    axios
      .post("/api/deactivatePromoCode", {
...
export default DisablePromoCode;
