...
class RestrictPromoCode extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit() {
    ...
    if (!codeNameValid) {
      return showNotification("danger", "Restrict Code", "Invalid code name");
    }
    // data is valid
    axios
      .post("/api/restrictPromoCode", {
...
export default RestrictPromoCode;
