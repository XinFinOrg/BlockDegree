...
module.exports = app => {
  ...
  app.get("/api/questionsProfessional", requireLogin, examServices.getQuestionsProfessional);
  app.get("/api/AnswersProfessional", requireLogin, examServices.getQuestionsProfessionalAnswers);
