          ...
          if (err) {
            ...
            files.forEach(async file => {
              ...
              browser
                ...
                .then(() => {
                  // asynchronous
                  var b64content = fs.readFileSync(localPath, {
                    encoding: "base64"
                  });
                  ...
                  T.post("media/upload", { media_data: b64content }, function (
                    ...
                    if (err) {
                      ...
                      T.post(
                        ...
                        console.error(
                          `Exception at T.post while Posting Tweeting: `,
                          e
                        );
                        return res.json({
                          error:
                ...
                .catch(e => {
                  console.error(`Exception at browser.close(): `, e);
                  return res.json({
                    error:
                      "Some error occured while posting,please try again after sometime or else contact-us",
                    uploaded: false
            ...
            media: [
              {
                ...
                originalUrl: "https://newuat.blockdegree.org/",
                title: {
                  text: "Blockdegree - Opensource blockchain training"
                }
              }
      ...
      browser
        ...
        .then(() => {
          ...
          os.execCommand(
            ...
            err => {
              console.error(
                "Error while uploading the media to the asset: ",
                err
              );
              return res.json({
                uploaded: false,
        ...
        .catch(e => {
          console.error(`Error while launching the browser: `, e);
        });
    });
  });
};
